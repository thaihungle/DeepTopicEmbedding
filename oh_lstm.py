...
def build_model(model_name='oh_lstm', conti=True):
    ...
    if os.path.isfile(fname_model) and conti:
        ...
        l_gru = GRU(100,return_sequences=True)(review_encoder)
        mp1=MaxPooling1D(100)(l_gru)
        l_gru2 = GRU(100,return_sequences=True, go_backwards=True)(review_encoder)
